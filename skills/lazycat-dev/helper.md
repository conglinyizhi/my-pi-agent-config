...
来源项目：https://github.com/.../pi-eco-debugger（已归档）
提取日期：2026-06-26
...
**文件**：[servers/esbuild-bundle.js](./servers/esbuild-bundle.js)
...
**文件**：[servers/version-reload.ts](./servers/version-reload.ts)

---

## 3. 部署后前端自动刷新

详见 [servers/version-reload.ts](./servers/version-reload.ts)，三个关键点：
...
**文件**：[components/debug-init.vue](./components/debug-init.vue)
